...
retriever = db.as_retriever(search_kwargss={"k": 5})
...
def reciprocal_rank_fusion(results: list[list], k=60):
    ...
    # Documents will by keyed by their contentss to ensure uniqueness
    fused_scores = {}
    documents = {}
    for docs in results:
        ...
        # sort the documentss based on their fused scores in descending order to get the final reranked results
